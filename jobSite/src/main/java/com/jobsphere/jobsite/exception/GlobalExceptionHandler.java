...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleAuthenticationException(AuthenticationException ex) {
        Map<String, Object> body = createErrorBody("authentication_failed", "Invalid credentials", HttpStatus.UNAUTHORIZED);
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(body);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleAllExceptions(Exception ex) {
        ...
        Map<String, Object> body = createErrorBody("internal_error", "An unexpected error occurred", HttpStatus.INTERNAL_SERVER_ERROR);
