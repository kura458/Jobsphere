...
public record JobUpdateRequest(
        @Size(max = JobConstants.TITLE_MAX_LENGTH) String title,

        String description,

        @Size(max = JobConstants.JOB_TYPE_MAX_LENGTH) String jobType,

        @Size(max = JobConstants.WORKPLACE_TYPE_MAX_LENGTH) String workplaceType,

        @Size(max = JobConstants.CATEGORY_MAX_LENGTH) String category,

        @Size(max = JobConstants.EDUCATION_LEVEL_MAX_LENGTH) String educationLevel,
